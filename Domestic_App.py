...
from Domestic_App_Window_ui import Ui_ChatGPT
from ChatGPT_conversation_3 import ChatGPT_conversation_3
from ChatGPT_conversation_4 import ChatGPT_conversation_4
from Token_check import TokenCounter  # 引入token计算
import datetime
from docx import Document
class Domestic_App_Window(QWidget):
    def __init__(self):
        super().__init__()
        # 设置图标
            ...
            while not success and retry_count < 3:
                try:
                    ...
                    if error:
                        ...
                        raise Exception(f"请求错误，60秒后进行第{retry_count+1}次重试，关闭本窗口即可")
                ...
                # 处理异常并实现重试逻辑
                    ...
                    self.gpt_error_signal.emit(str(e))
                    retry_count += 1
